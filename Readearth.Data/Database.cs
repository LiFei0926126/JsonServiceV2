...
namespace Readearth.Data
{
    ...
    public class Database
    {
        ...
        {
            //获取连接数据库的参数
            this.m_ConnectionString = connectStr;
        }
        #endregion
        ...
        /// <summary>
        /// <c>根据输入的查询语句，获取符合条件的数据集，数据集与DataReader的区别是DataReader是向前只读的，用于快速只读访问因此占用的资源少。Dataset提供数据存储空间。</c>
        /// </summary>
        /// <param name="queryString"><c>查询条件，当queryString为安全SQL语句的情况</c></param>
        /// <returns><c>数据集</c></returns>
        ...
        /// <summary>
        /// <c>根据输入的查询语句，获取符合条件的数据表</c>
        /// </summary>
        /// <param name="queryString"><c>查询条件</c></param>
        /// <returns><c>数据表</c></returns>
        ...
        /// <summary>
        /// 根据表名返回与指定表结构一致的同表名空表
        /// </summary>
        /// <param name="tableName"></param>
        /// <returns></returns>
        public DataTable GetVoidDataTable(string tableName)
        {
